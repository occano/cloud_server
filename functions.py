...
analysis = {
    'cylinders':
                {
                    '0': {'Torque_engine': {'value': 47734.56, 'std': -0.0, 'avg': 47988.11}, 'load': {'value': 31.98, 'std': -0.0, 'avg': 32.07}, 'firing_pressure': {'value': 111.96, 'std': -0.0, 'avg': 112.13}, 'scavenging_pressure': {'value': 0.62, 'std': -0.0, 'avg': 0.62}, 'compression_pressure': {'value': 86.99, 'std': 0.0, 'avg': 86.86}, 'break_power': {'value': 908.48, 'std': 0.0, 'avg': 908.06}, 'imep': {'value': 15.29, 'std': -0.01, 'avg': 15.32}, 'bmep': {'value': 11.38, 'std': 0.01, 'avg': 11.27}, 'injection_timing': {'value': 1.55, 'std': 0.01, 'avg': 1.53}, 'exhaust_temperature': {'value': 275.57, 'std': 0.01, 'avg': 272.42}, 'fuel_flow_rate': {'value': 284.71, 'std': 0.01, 'avg': 283.73}, 'engine_speed_mean': {'value': 49.08, 'std': 0.0, 'avg': 49.08}},
                    '1': {'Torque_engine': {'value': 50055.44, 'std': 0.02, 'avg': 47988.11}, 'load': {'value': 33.43, 'std': 0.02, 'avg': 32.07}, 'firing_pressure': {'value': 112.87, 'std': 0.02, 'avg': 112.13}, 'scavenging_pressure': {'value': 0.65, 'std': 0.02, 'avg': 0.62}, 'compression_pressure': {'value': 87.67, 'std': 0.02, 'avg': 86.86}, 'break_power': {'value': 1069.02, 'std': 0.02, 'avg': 908.06}, 'imep': {'value': 15.43, 'std': 0.02, 'avg': 15.32}, 'bmep': {'value': 11.29, 'std': 0.0, 'avg': 11.27}, 'injection_timing': {'value': 1.54, 'std': 0.01, 'avg': 1.53}, 'exhaust_temperature': {'value': 273.46, 'std': -0.0, 'avg': 272.42}, 'fuel_flow_rate': {'value': 286.77, 'std': 0.01, 'avg': 283.73}, 'engine_speed_mean': {'value': 49.08, 'std': 0.0, 'avg': 49.08}},
                    '2': {'Torque_engine': {'value': 45352.84, 'std': -0.02, 'avg': 47988.11}, 'load': {'value': 30.36, 'std': -0.02, 'avg': 32.07}, 'firing_pressure': {'value': 111.4, 'std': -0.02, 'avg': 112.13}, 'scavenging_pressure': {'value': 0.59, 'std': -0.03, 'avg': 0.62}, 'compression_pressure': {'value': 85.46, 'std': -0.03, 'avg': 86.86}, 'break_power': {'value': 710.25, 'std': -0.02, 'avg': 908.06}, 'imep': {'value': 15.19, 'std': -0.03, 'avg': 15.32}, 'bmep': {'value': 11.36, 'std': 0.01, 'avg': 11.27}, 'injection_timing': {'value': 1.52, 'std': -0.01, 'avg': 1.53}, 'exhaust_temperature': {'value': 272.03, 'std': 0.0, 'avg': 272.42}, 'fuel_flow_rate': {'value': 278.07, 'std': -0.02, 'avg': 283.73}, 'engine_speed_mean': {'value': 49.08, 'std': 0.0, 'avg': 49.08}},
                    '3': {'Torque_engine': {'value': 49010.19, 'std': 0.01, 'avg': 47988.11}, 'load': {'value': 33.06, 'std': 0.01, 'avg': 32.07}, 'firing_pressure': {'value': 112.4, 'std': 0.01, 'avg': 112.13}, 'scavenging_pressure': {'value': 0.62, 'std': 0.0, 'avg': 0.62}, 'compression_pressure': {'value': 87.6, 'std': 0.01, 'avg': 86.86}, 'break_power': {'value': 1033.42, 'std': 0.01, 'avg': 908.06}, 'imep': {'value': 15.29, 'std': -0.0, 'avg': 15.32}, 'bmep': {'value': 11.46, 'std': 0.01, 'avg': 11.27}, 'injection_timing': {'value': 1.55, 'std': 0.01, 'avg': 1.53}, 'exhaust_temperature': {'value': 277.96, 'std': 0.02, 'avg': 272.42}, 'fuel_flow_rate': {'value': 286.51, 'std': 0.01, 'avg': 283.73}, 'engine_speed_mean': {'value': 49.08, 'std': 0.0, 'avg': 49.08}},
                    '4': {'Torque_engine': {'value': 49793.36, 'std': 0.02, 'avg': 47988.11}, 'load': {'value': 33.26, 'std': 0.02, 'avg': 32.07}, 'firing_pressure': {'value': 112.55, 'std': 0.01, 'avg': 112.13}, 'scavenging_pressure': {'value': 0.64, 'std': 0.01, 'avg': 0.62}, 'compression_pressure': {'value': 87.12, 'std': 0.0, 'avg': 86.86}, 'break_power': {'value': 1018.96, 'std': 0.01, 'avg': 908.06}, 'imep': {'value': 15.39, 'std': 0.01, 'avg': 15.32}, 'bmep': {'value': 11.4, 'std': 0.01, 'avg': 11.27}, 'injection_timing': {'value': 1.53, 'std': 0.01, 'avg': 1.53}, 'exhaust_temperature': {'value': 275.44, 'std': 0.01, 'avg': 272.42}, 'fuel_flow_rate': {'value': 284.67, 'std': 0.01, 'avg': 283.73}, 'engine_speed_mean': {'value': 49.08, 'std': 0.0, 'avg': 49.08}},
                    '5': {'Torque_engine': {'value': 49777.68, 'std': 0.02, 'avg': 47988.11}, 'load': {'value': 33.35, 'std': 0.02, 'avg': 32.07}, 'firing_pressure': {'value': 113.03, 'std': 0.02, 'avg': 112.13}, 'scavenging_pressure': {'value': 0.64, 'std': 0.01, 'avg': 0.62}, 'compression_pressure': {'value': 87.27, 'std': 0.01, 'avg': 86.86}, 'break_power': {'value': 1050.71, 'std': 0.02, 'avg': 908.06}, 'imep': {'value': 15.4, 'std': 0.02, 'avg': 15.32}, 'bmep': {'value': 11.19, 'std': 0.0, 'avg': 11.27}, 'injection_timing': {'value': 1.52, 'std': -0.0, 'avg': 1.53}, 'exhaust_temperature': {'value': 269.53, 'std': -0.0, 'avg': 272.42}, 'fuel_flow_rate': {'value': 284.24, 'std': 0.0, 'avg': 283.73}, 'engine_speed_mean': {'value': 49.08, 'std': 0.0, 'avg': 49.08}},
                    '6': {'Torque_engine': {'value': 45541.72, 'std': -0.02, 'avg': 47988.11}, 'load': {'value': 30.16, 'std': -0.03, 'avg': 32.07}, 'firing_pressure': {'value': 111.05, 'std': -0.02, 'avg': 112.13}, 'scavenging_pressure': {'value': 0.62, 'std': -0.0, 'avg': 0.62}, 'compression_pressure': {'value': 86.54, 'std': -0.01, 'avg': 86.86}, 'break_power': {'value': 691.16, 'std': -0.03, 'avg': 908.06}, 'imep': {'value': 15.24, 'std': -0.01, 'avg': 15.32}, 'bmep': {'value': 10.89, 'std': -0.04, 'avg': 11.27}, 'injection_timing': {'value': 1.52, 'std': -0.01, 'avg': 1.53}, 'exhaust_temperature': {'value': 265.92, 'std': -0.02, 'avg': 272.42}, 'fuel_flow_rate': {'value': 283.54, 'std': -0.0, 'avg': 283.73}, 'engine_speed_mean': {'value': 49.08, 'std': 0.0, 'avg': 49.08}},
                    '7': {'Torque_engine': {'value': 46639.06, 'std': -0.01, 'avg': 47988.11}, 'load': {'value': 30.97, 'std': -0.02, 'avg': 32.07}, 'firing_pressure': {'value': 111.78, 'std': -0.01, 'avg': 112.13}, 'scavenging_pressure': {'value': 0.62, 'std': -0.01, 'avg': 0.62}, 'compression_pressure': {'value': 86.22, 'std': -0.01, 'avg': 86.86}, 'break_power': {'value': 782.47, 'std': -0.01, 'avg': 908.06}, 'imep': {'value': 15.3, 'std': -0.01, 'avg': 15.32}, 'bmep': {'value': 11.19, 'std': -0.01, 'avg': 11.27}, 'injection_timing': {'value': 1.52, 'std': -0.01, 'avg': 1.53}, 'exhaust_temperature': {'value': 269.48, 'std': -0.01, 'avg': 272.42}, 'fuel_flow_rate': {'value': 281.33, 'std': -0.01, 'avg': 283.73}, 'engine_speed_mean': {'value': 49.08, 'std': 0.0, 'avg': 49.08}}
                },
    'insights': [
        {'type': 'alert', 'location': 'cylinder #3', 'description': 'Scavenging Air Pressure at -0.03 std away from best performance', 'labels': {'Average Scavenging Air Pressure': 0.62, 'Scavenging Air Pressure': 0.59}},
        {'type': 'alert', 'location': 'cylinder #3', 'description': 'Compression Pressure at -0.03 std away from best performance', 'labels': {'Average Compression Pressure': 86.86, 'Compression Pressure': 85.46}},
        {'type': 'alert', 'location': 'cylinder #7', 'description': 'Load at -0.03 std away from best performance', 'labels': {'Average Load': 32.07, 'Load': 30.16}},
        {'type': 'alert', 'location': 'cylinder #7', 'description': 'Break Power at -0.03 std away from best performance', 'labels': {'Average Break Power': 908.06, 'Break Power': 691.16}}
    ]
}
